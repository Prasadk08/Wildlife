...
export const Card = React.memo(({
  ...
  <div
    ...
    className={cn(
      "rounded-lg relative bg-gray-100 dark:bg-neutral-900 overflow-hidden h-auto w-auto md:max-h-96 w-full transition-all duration-300 ease-out",
    ...
    <div
      ...
      <div
        className="text-xs p-2 md:text-lg font-medium bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-200">
        {card.description}
      </div>
      <div
        className="text-xs p-2 md:text-lg font-medium bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-200">
